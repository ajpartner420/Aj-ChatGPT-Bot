    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                footer_credit = "<b><a href='https://t.me/MOVIE_REQUEST_GROUP_AJ'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://t.me/Aj_The_Warrior'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a></b>"
                ...
                print(error)
                await message.reply_text(f"**An error occurred:**\n\n**{error}**\n\n**Forward This Message To @Aj_The_Warrior**")
    else:
        return
